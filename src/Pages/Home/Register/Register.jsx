...
const Register = () => {
    return (
        <div className='lg:py-10 w-full relative h-[1950px] lg:h-[1250px]'>
  ...
  <div className="hero-content text-center text-neutral-content">
    <div className=" space-y-3">
      ...
      <p className='text-gray-200'>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod <br className='hidden lg:block' /> tempor incididunt ut labore et dolore magna aliqua</p>
    </div>
  </div>
            </div>
            <div className='lg:flex absolute w-full lg:w-[85%] top-96 mt-56 lg:mt-32 rounded-tl-3xl rounded-br-3xl gap-10 lg:mx-20 p-5 lg:p-16 bg-white shadow-2xl'>
                ...
                <div className='w-full relative'>
                    <div className='lg:px-5 bg-black rounded-tl-[40px] rounded-br-[30px]'>
