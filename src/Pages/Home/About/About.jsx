...
const About = () => {
    return (
        <div className='px-2 w-full lg:px-10 py-20 lg:flex gap-10'>
            <div className='w-[100%]  relative'>
                ...
                <img className='absolute w-[62%] -mb-3 h-[50%] rounded-2xl border-[15px] border-white lg:-mr-16 right-0 bottom-0 object-cover' src={aboutPrint} alt="" />

             
            </div>
            <div className='space-y-5 mt-16'>
                <p className='italic text-2xl text-red-700'>About Articio</p>
                <h1 className='text-3xl lg:text-5xl font-semibold'>Learn The Art From The Core And Pursue Your Passion</h1>
                ...
                <div className='flex items-center'>
                    <div className='w-[80%] space-y-1 py-2 lg:border-r-4'>
                    ...
                    <h5 className='px-3 lg:px-10 py-2 text-gray-500 text-lg space-y-1'>Accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum deleniti atque corrupti</h5>
                </div>
                <div className='flex items-center'>
                    <div className='w-[91%] space-y-1 py-2 lg:border-r-4'>
                ...
                <div className='flex items-center gap-3 lg:gap-14'>
                    <div className='flex lg:px-10 gap-5 justify-center items-center'>
